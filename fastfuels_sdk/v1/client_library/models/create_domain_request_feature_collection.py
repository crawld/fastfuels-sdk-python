...
class CreateDomainRequestFeatureCollection(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "features", "name", "description", "horizontalResolution", "verticalResolution", "crs", "tags"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateDomainRequestFeatureCollection from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateDomainRequestFeatureCollection from a dict"""
        if obj is None:
            return None
