...
class TopographyGridLandfireSource(BaseModel):
    """
    TopographyGridLandfireSource
    """ # noqa: E501
    source: Optional[StrictStr] = 'LANDFIRE'
    version: Optional[StrictStr] = '2020'
    interpolation_method: Optional[TopographyGridInterpolationMethod] = Field(default=None, alias="interpolationMethod")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TopographyGridLandfireSource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TopographyGridLandfireSource from a dict"""
        if obj is None:
            return None
