...
class SurfaceGrid(BaseModel):
    ...
    fuel_load: Optional[Fuelload] = Field(default=None, alias="fuelLoad")
    fuel_depth: Optional[Fueldepth] = Field(default=None, alias="fuelDepth")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fuelLoad": Fuelload.from_dict(obj["fuelLoad"]) if obj.get("fuelLoad") is not None else None,
            "fuelDepth": Fueldepth.from_dict(obj["fuelDepth"]) if obj.get("fuelDepth") is not None else None,
