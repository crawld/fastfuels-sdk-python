...
class FeatureGrid(BaseModel):
    ...
    FeatureGrid
    """ # noqa: E501
    attributes: List[FeatureGridAttribute] = Field(description="List of feature types to rasterize.")
    ...
    __properties: ClassVar[List[str]] = ["attributes", "status", "createdOn", "modifiedOn", "checksum"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FeatureGrid from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FeatureGrid from a dict"""
        if obj is None:
            return None
