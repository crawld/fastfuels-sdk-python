...
class CreateDomainRequestFeature(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "geometry", "properties", "name", "description", "horizontalResolution", "verticalResolution", "crs", "tags"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateDomainRequestFeature from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateDomainRequestFeature from a dict"""
        if obj is None:
            return None
