...
class WaterFeatureApi:
    ...
    def get_water_feature_data(
        ...
        # Get Water Feature Data  This endpoint retrieves paginated water feature data for a specific domain. Water feature data represents individual water bodies and their attributes (e.g., lakes, rivers, streams) in GeoJSON format.  The water feature resource must be created and fully processed (status \"completed\") before data can be retrieved through this endpoint.  ## Endpoint  ``` GET /v1/domains/{domainId}/features/water/data ```  ## Path Parameters  - `domainId` (string, required): The unique identifier of the domain for which you want to retrieve water feature data.  ## Query Parameters  - `page` (integer, optional): Zero-indexed page number. Must be greater than or equal to 0. Defaults to `0`. - `size` (integer, optional): Number of features to return per page. Valid range: `1` to `1000`. Defaults to `50`.  ## Response  If the request is successful, the endpoint will return a `200 OK` status code and a GeoJSON FeatureCollection with pagination metadata. The response body will contain:  - `type` (string): Always \"FeatureCollection\". - `features` (array): Array of GeoJSON Feature objects representing individual water bodies. - `currentPage` (integer): The current page number returned. - `pageSize` (integer): The number of features per page. - `totalItems` (integer): The total number of water features available in the domain. - `crs` (object, optional): Coordinate reference system information for the domain.  ## Error Responses  - `404 Not Found`: The specified domain does not exist, the user does not have access to it, or no water feature resource exists for this domain. - `422 Unprocessable Entity`: The water feature resource does not have status 'completed', or validation failed for query parameters. - `401 Unauthorized`: The request lacks valid authentication credentials. - `403 Forbidden`: The authenticated user does not have permission to access this domain.  ## Usage Notes  - The water feature resource must be created and have status 'completed' before data can be retrieved. - Use the pagination parameters to retrieve large datasets efficiently. - The `totalItems` field can be used to calculate the total number of pages available.
        ...
        _param = self._get_water_feature_data_serialize(
            domain_id=domain_id,
            page=page,
            size=size,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_water_feature_data_with_http_info(
        self,
        domain_id: StrictStr,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The page number to retrieve. Page number is zero-indexed.")] = None,
        size: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="The number of resources to retrieve per page.")] = None,
    ...
    @validate_call
    def get_water_feature_data_without_preload_content(
        self,
        domain_id: StrictStr,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="The page number to retrieve. Page number is zero-indexed.")] = None,
        size: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="The number of resources to retrieve per page.")] = None,
    ...
    def _get_water_feature_data_serialize(
        self,
        domain_id,
        page,
        size,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/domains/{domainId}/features/water/data',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
