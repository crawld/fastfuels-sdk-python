"""
fastfuels_sdk/v1/grids/topography_grid.py
"""
...
# Internal imports
from fastfuels_sdk.v1.api import get_topography_grid_api
from fastfuels_sdk.v1.utils import format_processing_error
from fastfuels_sdk.v1.exports import Export
from fastfuels_sdk.v1.client_library.models import (
    ...
    def wait_until_completed(
        ...
        while topography_grid.status != "completed":
            if topography_grid.status == "failed":
                error_msg = "Topography grid processing failed."

                # Extract detailed error information if available
                error_obj = getattr(topography_grid, "error", None)
                if error_obj:
