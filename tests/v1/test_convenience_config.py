"""
tests/v1/test_convenience_config.py
...
# Internal imports
from fastfuels_sdk.v1.convenience import (
...
class TestDefaultConfigurations:
    ...
    @patch("fastfuels_sdk.v1.convenience.Domain")
    @patch("fastfuels_sdk.v1.convenience.Features")
    @patch("fastfuels_sdk.v1.convenience.TopographyGridBuilder")
    @patch("fastfuels_sdk.v1.convenience.SurfaceGridBuilder")
    @patch("fastfuels_sdk.v1.convenience.TreeGridBuilder")
    @patch("fastfuels_sdk.v1.convenience.Grids")
    @patch("fastfuels_sdk.v1.convenience.Inventories")
...
class TestConfigurationMerger:
    ...
    def test_merge_config_with_none_returns_default(self):
        ...
        from fastfuels_sdk.v1.convenience import _merge_config
...
class TestTopographyConfigProcessor:
    ...
    def test_configure_topography_builder_landfire_source(self, mock_builder_class):
        ...
        from fastfuels_sdk.v1.convenience import _configure_topography_builder
...
class TestSurfaceConfigProcessor:
    ...
    def test_configure_surface_builder_custom_fuel_moisture(self, mock_builder_class):
        ...
        from fastfuels_sdk.v1.convenience import _configure_surface_builder
...
class TestTreeConfigProcessor:
    ...
    def test_configure_tree_builder_custom_fuel_moisture(self, mock_builder_class):
        ...
        from fastfuels_sdk.v1.convenience import _configure_tree_builder
...
class TestIntegratedConfigurationSystem:
    ...
    @patch("fastfuels_sdk.v1.convenience.Domain")
    @patch("fastfuels_sdk.v1.convenience.Features")
    @patch("fastfuels_sdk.v1.convenience._configure_topography_builder")
    @patch("fastfuels_sdk.v1.convenience._configure_surface_builder")
    @patch("fastfuels_sdk.v1.convenience._configure_tree_builder")
    @patch("fastfuels_sdk.v1.convenience.Grids")
    @patch("fastfuels_sdk.v1.convenience.Inventories")
    def test_export_roi_with_surface_fuel_moisture_config(
        ...
        from fastfuels_sdk.v1.convenience import export_roi_to_quicfire
...
class TestExportRoiFormats:
    ...
    def test_export_roi_default_quicfire_format(
        ...
        from fastfuels_sdk.v1.convenience import export_roi
    ...
    @patch("fastfuels_sdk.v1.convenience.export_roi")
